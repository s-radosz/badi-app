const lang = {
    ...
    registerAcceptTerms: {
        en: 'By continuing you accept app terms',
        pl: 'Zakładając konto akceptujesz regulamin Budi',
    },
    register: {
        en: 'Sign Up',
        pl: 'Zarejestruj',
    ...
    passwordAndConfirmationNotMatchedError: {
        en: 'Password and password confirmation must be the same',
        pl: 'Hasło i potwierdzenie muszą być identyczne',
    },
    passwordLengthError: {
    ...
    accountExistsError: {
        ...
        pl: 'Konto dla podanego email juz istnieje',
    },
