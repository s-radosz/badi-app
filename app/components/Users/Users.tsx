                                ...
                                <ScrollView>
                                    ...
                                    {userList && !showFilterModal && (
                                        <View data-test="Carousel">
                                            <Text
                                                style={
                                                    styles.filterResultsHeaderText
                                                }>
                                                {lang.filterResults['pl']}
                                            </Text>
                                            <View
                                                style={
                                                    styles.filterResultsCarousel
                                                }>
                                                <Carousel
                                                    layout={'default'}
