                    ...
                    await this.setState({
                        ...
                        usersAreInTheSameConversation:
                            response.data.result
                                .checkIfUsersAreInNormalConversation,
                    });
                }
            })
            .catch(async error => {
        ...
        axios
            ...
            .then(response =>
                axios.post(API_URL + '/api/addNotification', {
                    ...
                    message: `${this.context.userData.name} ${lang.acceptYourInvitationSuccess['pl']}`,
                    userId: receiverId,
        ...
        axios
            ...
            .then(response => {
                if (response.data.status === 'OK') {
                    ...
                    this.context.setAlert(
                        true,
                        'success',
                        lang.invitationSendedSuccess['pl'],
                    );
                    this.setShowUserDetails(this.state.userDetailsId);
                }
            })
            .then(response =>
                axios.post(API_URL + '/api/addNotification', {
                    ...
                    message: `${this.context.userData.name} ${lang.inviteToFriends['pl']}`,
                    userId: receiverId,
                    senderId: this.context.userData.id,
                    openDetailsId: openDetailsId,
                }),
                                        ...
                                        <React.Fragment>
                                            ...
                                            {usersAreInTheSameConversation &&
                                                this.props.navigation.state
                                                    ...
                                                    <Text
                                                        style={
                                                            styles.userDetailsContentHobbyContainer
                                                        }>
                                                        {
                                                            lang
                                                                .conversationExists[
                                            ...
                                            <View
                                                style={
                                                    styles.userDetailsRedirectMessageBtnContainer
                                                }>
                                                {usersAreInTheSameConversation &&
                                                this.props.navigation.state
                                                    .params.showBtns ? (
