                            ...
                            this.context.showLoader ? (
                                ...
                                <React.Fragment>
                                    <ScrollView
                                        ...
                                        <View
                                            style={
                                                styles.addNewProductInputContainer
                                            }>
                                            <InputComponent
                                                placeholder={
                                                    lang.addProductName['pl']
                                                }
                                                inputOnChange={(name: string) =>
                                                    this.setState({name})
                                                }
                                                value={name}
                                        ...
                                        <View
                                            style={
                                                styles.addNewProductDescInput
                                            }>
                                            <TextAreaComponent
                                                placeholder={
                                                    lang.addProductDescription[
                                                        'pl'
                                                    ]
                                                }
                                                inputOnChange={(
                                        ...
                                        <View
                                            style={
                                                styles.addNewProductOptionContainer
                                            }>
                                            <Text
                                                style={
                                                    styles.addNewProductOptionHeaderText
                                                }>
                                                {lang.category['pl']}
                                            </Text>
                                            <View
                                                style={
                                                    styles.addNewProductOptionWrapper
                                                }>
                                                {categories.map(
                                                    (
                                                        category: any,
