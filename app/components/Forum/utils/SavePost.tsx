...
class SavePost extends Component<SavePostProps, SavePostState> {
    ...
    savePost = (
        ...
        if (!title || !description || categoryId === 0) {
            this.context.setAlert(true, 'danger', lang.allFieldsError['pl']);
        }
                ...
                .then(response => {
                    if (response.data.status === 'OK') {
                        ...
                        this.context.setAlert(
                            true,
                            'success',
                            lang.postAddedSuccess['pl'],
                        );
                    } else {
                        this.context.setAlert(
                            true,
                            'danger',
                            lang.postAddedError['pl'],
                        );
                    }
                })
                .catch(error => {
                            ...
                            <React.Fragment>
                                <ScrollView
                                    ...
                                    <View style={{marginBottom: 10}}>
                                        <View
                                            style={
                                                styles.savePostInputContainer
                                            }>
                                            <InputComponent
                                                placeholder={lang.subject['pl']}
                                                inputOnChange={(
                                                    title: string,
                                                ) => this.setState({title})}
                                        ...
                                        <Text
                                            style={
                                                styles.savePostCategoryHeaderText
                                            }>
                                            {lang.category['pl']}
                                        </Text>
