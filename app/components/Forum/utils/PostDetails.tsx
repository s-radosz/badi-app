            ...
            axios
              ...
              that.context.userData.id
                        ...
                        await this.setState({
                            ...
                            authorPhotoPath:
                                response.data.result[0].users.photo_path,
                ...
                .catch(async error => {
                    await this.context.setAlert(
                        true,
                        'danger',
                        lang.postDetailsError['pl'],
                    );

                    await this.context.setShowLoader(false);
                });
        } catch (e) {
            this.context.setAlert(true, 'danger', lang.postDetailsError['pl']);
        }
    };
                ...
                .then(response => {
                    if (response.data.status === 'OK') {
                        ...
                        this.context.setAlert(
                            true,
                            'danger',
                            lang.existsCommentVoteError['pl'],
                        );
                    }
                })
                .catch(error => {
                    this.context.setAlert(
                        true,
                        'danger',
                        lang.voteSaveError['pl'],
                    );
                });
        } else {
            this.context.setAlert(true, 'danger', lang.voteSaveError['pl']);
        }
    };
                        ...
                        {this.context.showLoader ? (
                            ...
                            <React.Fragment>
                                <ScrollView
                                    ...
                                    <View
                                        style={
                                            styles.postDetailsContainerPadding
                                        }>
                                        <View
                                            ...
                                            <View
                                                style={
                                                    styles.postDetailsAuthorContainer
                                                }>
                                                <Text
                                                    style={
                                                        styles.postDetailsAuthorContainerName
                                                    }>
                                                    {authorName}
                                                </Text>
                                                {authorId !==
                                        ...
                                        <Text style={styles.postDetailsDesc}>
                                            {postDesc}
                                        </Text>
                                        <Text
                                            style={styles.postDetailsPostDate}>
                                            {lang.createdAt['pl']}{' '}
                                            {postDateConverted}
                                        </Text>
                                        <View
                                            style={
                                                styles.postDetailsPostVoteContainer
                                            }>
                                            <View
                                                style={
                                                    styles.postDetailsPostVoteWrapper
                                                }>
                                                <Text
                                                    style={
                                                        styles.postDetailsPostVoteCount
                                                    }>
                                                    {postVotes}
                                                </Text>
                                                <TouchableOpacity
                                                    ...
                                                    <Image
                                                        style={
                                                            styles.postDetailsPostVoteImage
                                                        }
                                                        resizeMode="contain"
                                                        source={like}
                                                    />
                                            ...
                                            <View
                                                style={
                                                    styles.postDetailsPostCommentCountWrapper
                                                }>
                                                <Text
                                                    style={
                                                        styles.postDetailsPostCommentCountText
                                                    }>
                                                    {comments.length}
                                                </Text>
                                                <TouchableOpacity>
                                        ...
                                        {comments.length > 0 ? (
                                            <Text
                                                style={
                                                    styles.postDetailsPostCommentListHeader
                                                }>
                                                {lang.comments['pl']}
                                            </Text>
                                        ) : null}
